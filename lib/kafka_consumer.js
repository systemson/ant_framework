...
class BaseConsumer {
    constructor() {
        this.groupId = (0, StringUtils_1.snakeCase)((0, helpers_1.getEnv)("KAFKA_CONSUMER_GROUP_ID", "my-group"));
        this.topic = (0, StringUtils_1.snakeCase)((0, helpers_1.getEnv)("KAFKA_DEFAULT_TOPIC", "my-topic"));
    }
    boot(base) {
