...
class App {
    ...
    boot() {
        return new Promise((resolve, rejects) => {
            logger_1.Logger.debug(helpers_1.Lang.__(`Node {{node}}-{{platform}}-{{arch}} [{{env}}]`, {
                node: process.version,
                platform: os_1.default.platform(),
                arch: os_1.default.arch(),
                env: helpers_1.NODE_ENV
            }));
            logger_1.Logger.debug(helpers_1.Lang.__(`{{type}} {{release}}`, {
                release: os_1.default.release(),
                type: os_1.default.type(),
            }));
            logger_1.Logger.debug(helpers_1.Lang.__("Enviroment [{{env}}].", { env: helpers_1.NODE_ENV }));
