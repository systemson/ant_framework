...
exports.NODE_ENV = process.pkg ? "production" : (_b = (_a = process.env.NODE_ENV) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "development";
...
function logCatchedError(error) {
    ...
    if ((exports.NODE_ENV === null || exports.NODE_ENV === void 0 ? void 0 : exports.NODE_ENV.trim()) === "development") {
