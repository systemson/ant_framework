...
function getConnectionConfig(type, extra, sufix = "") {
    let config = {
        ...
        sid: (0, helpers_1.getEnv)(`DB_DATABASE${sufix}`),
        schema: (0, helpers_1.getEnv)(`DB_SCHEMA${sufix}`, ""),
        entityPrefix: (0, helpers_1.getEnv)(`BD_PREFIX${sufix}`),
        synchronize: (0, helpers_1.envIsTrue)(["DB_RESTART", "DB_SYNCHRONIZE"]),
        dropSchema: (0, helpers_1.envIsTrue)(["DB_RESTART", "DB_DROP_SCHEMA"]),
        migrationsRun: (0, helpers_1.envIsTrue)(["DB_RESTART", "DB_MIGRATE"]),
        logging: (0, helpers_1.envIsTrue)(["BD_DEBUG"]),
        ssl: (0, helpers_1.envIsTrue)(["DB_SSL"]),
        extra: {
            ssl: (0, helpers_1.envIsTrue)(["DB_SSL"]) ? {
    ...
    switch (type) {
        ...
        case "sqlite":
        case "better-sqlite3":
            config = Object.assign(Object.assign({}, config), { database: (0, helpers_1.getEnv)("DB_DATABASE"), entityPrefix: (0, helpers_1.getEnv)("BD_PREFIX") });
            break;
        default:
