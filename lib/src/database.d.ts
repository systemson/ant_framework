import { DatabaseType, DefaultNamingStrategy, NamingStrategyInterface, Logger as TypeOrmLogContract, DataSourceOptions } from "typeorm";
...
export declare function getConnectionConfig(type: Exclude<DatabaseType, "aurora-data-api" | "aurora-data-api-pg" | "expo" | "capacitor">, extra?: Partial<DataSourceOptions>): Exclude<DataSourceOptions, "CapacitorDataSourceOptions">;
